                ...
                <div class="small-dialog login-register">
                    ...
                    <div class="">
                        ...
                        <div class="small-dialog-content">
                            ...
                            <form id="cariera_registration" action="{{ route('login') }}" method="POST">
								@csrf                                

                                <div class="form-group">
                                    <label for="movify_user_email">Email</label>
                                    <input type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" id="email" name="email" value="{{ old('email') }}" placeholder="Your Email *" required autofocus  />
									@if ($errors->has('email'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" id="password" name="password" placeholder="Your Password *" required/>
								...
								<div class="form-group">
                                    <div class="checkbox pad-bottom-10">
                                        <input id="check1" type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}>
